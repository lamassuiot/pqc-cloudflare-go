...
import (
	...
	common "cloudflare/circl/sign/internal/dilithium"
	"cloudflare/circl/sign/mldsa/mldsa44/internal"
)
...
func (sk *PrivateKey) UnmarshalBinary(data []byte) error {
	...
	default:
		if len(data) != (SeedSize + PrivateKeySize + 6) {
			return errors.New("packed private key must be of mldsa44.PrivateKeySize, mldsa44.KeySize or mldsa44.PrivateKeySize + mldsa44.KeySize + 6 bytes")
		}
